...
public class BiggerBoxBlock extends BlockWithEntity {

    public static final MapCodec<BiggerBoxBlock> CODEC = RecordCodecBuilder.mapCodec(
            instance -> instance.group(DyeColor.CODEC.optionalFieldOf("color").forGetter(block -> Optional.ofNullable(block.color)), createSettingsCodec())
                    .apply(instance, (color, settings) -> new BiggerBoxBlock((DyeColor) color.orElse(null), settings))
    );
    ...
    public BiggerBoxBlock(@Nullable DyeColor color, AbstractBlock.Settings settings) {
        super(settings);
        this.color = color;
    ...
    public static Block get(@Nullable DyeColor dyeColor) {
        if (dyeColor == null) {
            return MahiroBlocks.BIGGERBOX;
        } else {
            return switch (dyeColor) {
                case WHITE -> MahiroBlocks.WHITE_BIGGERBOX;
                case ORANGE -> MahiroBlocks.ORANGE_BIGGERBOX;
                case MAGENTA -> MahiroBlocks.MAGENTA_BIGGERBOX;
                case LIGHT_BLUE -> MahiroBlocks.LIGHT_BLUE_BIGGERBOX;
                case YELLOW -> MahiroBlocks.YELLOW_BIGGERBOX;
                case LIME -> MahiroBlocks.LIME_BIGGERBOX;
                case PINK -> MahiroBlocks.PINK_BIGGERBOX;
                case GRAY -> MahiroBlocks.GRAY_BIGGERBOX;
                case LIGHT_GRAY -> MahiroBlocks.LIGHT_GRAY_BIGGERBOX;
                case CYAN -> MahiroBlocks.CYAN_BIGGERBOX;
                case BLUE -> MahiroBlocks.BLUE_BIGGERBOX;
                case BROWN -> MahiroBlocks.BROWN_BIGGERBOX;
                case GREEN -> MahiroBlocks.GREEN_BIGGERBOX;
                case RED -> MahiroBlocks.RED_BIGGERBOX;
                case BLACK -> MahiroBlocks.BLACK_BIGGERBOX;
                case PURPLE -> MahiroBlocks.PURPLE_BIGGERBOX;
            };
        }
    }
